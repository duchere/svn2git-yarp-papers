...
In practice, most of the $\alpha_i$ are
found to be zero after training; the vectors with an associated $\alpha_i$
different from zero are the support vectors. Notice hence that the testing
time of a new point is proportional to the number of SVs.
