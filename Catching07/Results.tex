...
\begin{figure}[tbp]
	\centering
		...
		\caption{Difference (in pixel) between $e_p$ and $e_r$ for a representative test subject.  For a definition of $e_p$ and $e_r$ see the caption of Fig \ref{figSchemaRetta}. A positive value of the plot indicates that the paddle at the interception time is nearer to the ball arrival point along the straight line, while a negative value means that the paddle is nearer to the real arrival point of the ball, that follows a parabolic path.}
\label{figRetta}
\end{figure}
...
\includegraphics[width =8cm]{fig/MediaRettaTmeno.eps}
		...
		\includegraphics[width =8cm]{fig/MediaRettaControllo.eps}
		\caption{\textbf{Above} - Mean difference (in pixel) between $e_p$ and $e_r$ in each test group: \textit{Left} - test, downward direction, \textit{Right} - test, upward  direction. \textbf{Below} - Mean difference (in pixel) between $e_p$ and $e_r$ in control group. For a definition of $e_p$ and $e_r$ see the caption of Fig \ref{figSchemaRetta}. A positive value of the plot indicates that the paddle at the interception time is nearer to the ball arrival point along the straight line, while a negative value means that the paddle is nearer to the real arrival point of the ball, that follows a parabolic path.}
		\label{figMedieRetta}
\end{figure}
