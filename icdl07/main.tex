...
\author{\authorblockN{Lorenzo Natale, Francesco Nori, Giulio Sandini}
\authorblockA{
\textit{Italian Institute of Technology}\\
\textit{Via Morego 30, Genova, ITALY}\\
\textit{\{lorenzo.natale, francesco.nori, giulio.sandini\}@iit.it}\\}
\and
...
can reach for visually identified objects in 3-D space by 
integrating an open loop and a closed loop component; the open loop controller allows 
