...
are relevant to understand the remainder of the paper are:nd the remainder of the paper are: $\mathbf q_{head}$ = $\begin{bmatrix} \alpha_t^c & \alpha_v^d & \alpha_v^c & \theta_y & \theta_p & \theta_r \end{bmatrix}^\top \in \mathbb R^6$
and the subset of arm joints from the shoulder to the elbow (assuming
that the wrist DOFs affect only the orientation of the hand): 
