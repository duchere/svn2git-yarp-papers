...
% and improving how robots interact with the world.
...
%In this context we focus on reaching, which is a clear prerequisite for 
%manipulation. If vision of the hand and target were available then this problem 
...
%estimation 
%of the Jacobian allows a convergent controller. The visual
%servoing approach is not necessarily the best solution: it requires continuous 
...
%reducing the error of the task to zero.  
