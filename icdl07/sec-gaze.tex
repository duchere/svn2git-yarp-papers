...
assumptions\footnote{\input{footnote1}}, we do not need to impose simultaneously 
...
satisfied\footnote{\input{footnote2}}. Under this simplification we have that 
...
freedom. Roughly speaking\footnote{\input{footnote3}}, we are imposing 
