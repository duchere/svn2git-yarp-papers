...
various algorithms. Discussing the different properties of these numerical 
...
\begin{figure}[tbhp]
\centerline{
\includegraphics[width=3.0in, angle=0 ]{./Figure/reachingError1.eps}
...
\begin{figure}[tbp]
\centerline{
\includegraphics[width=3.5in, angle=0 ]{./Figure/jacobian-error.eps}
