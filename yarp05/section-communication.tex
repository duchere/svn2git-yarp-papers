...
every free output connection (to block and wait for all sends to finish before trying the next one, {\em FinisheSend} can be called).  The buffer will be retained
