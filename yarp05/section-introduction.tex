...
development and maintainability. In the last few years we have been developing
...
successfully used on several platforms
\cite{natale05linking,beltrangonzalez05visual,torresjara05tapping,aryananda04mertz,AaronArm,breazeal99how,brooks99cog}
...
\caption {
Robots using YARP, and the number of computers they use (this 
count does not include processors such as DSPs,
often used for low-level motor control).
}
\label{tab:robots}
\end{table}
...
Let us now introduce  YARP by describing the high-level lessons
we have learned and applied within it.
%
%
...
Over time, software for a sophisticated robot needs to 
...
can link and call C++ code. We have successfully used
...
on one OS as opposed to another. This can happen for example if 
