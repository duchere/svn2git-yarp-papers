...
Building on our robot software architecture YARP~\cite{metta2006yarp},
...
in use (allowing several to be used simultaneously, key to
smooth evolution).
%
...
%
At the same time, we are concerned with the
