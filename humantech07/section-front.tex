...
``middleware.''  On the network, basic interoperation is possible by a 
simple plain-text representation across TCP/IP sockets.
%
Maximally efficient interoperation with YARP for demanding scenarios 
can be achieved through documented protocols.
%
While typical users of YARP need know nothing of this,
their work benefits by being automatically easier 
