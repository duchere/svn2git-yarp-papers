...
starting to be more frequently used, together with its quasi-synonym 
of ``Open Design''. From the Wikipedia ``Open Design'', we can read: 
...
resources beyond those available of any one laboratory} that collaborate
through the {\em copyleft mechanism}.
