...
\begin{figure}[tbp]
\centerline{
\includegraphics[width=15cm]{fig-icub}
}
...
design of the RobotCub platform. The design of the robot started from 
...
Without a good documentation it is very complicated to build and assemble 
...
automated and requires a substantial human intervention. There is a clear dependency 
of the 2D drawings from the 3D CAD model. To guarantee the same type of virtuous 
development cycle of open source software, the 3D CAD is required, changes happen 
...
it eases the preparation of the standards. In RobotCub we were forced to choose a specific 
set of tools for mechanical and electronic CAD and future upgrades will have to strictly 
adhere to these standards. Due to the absence of open source professional design tools, RobotCub
...
joints, gearboxes, and more in general powerful actuators or as alternative
...
platform. It cannot be considered akin the AIBO, nor a more industrial realization 
like the HRP2.
...
to the hardware (read fast loops). The Pentium, a PC104 format CPU card, is 
