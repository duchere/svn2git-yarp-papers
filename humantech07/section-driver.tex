...
Interfaces to broad families of devices have been defined in YARP. The 
minimum interface to a YARP device is called DeviceDriver and defines 
methods to open and close a device. Other families of devices defined in YARP
are:
...
interface to a PID controller, including methods to read or set the value of the 
gains.
...
Other interfaces defined in YARP are the 
