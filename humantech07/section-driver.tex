...
because they tend to make the particular set of assumptions made by 
...
source code dependencies are reduced reduced. In YARP wrappers can be 
...
initialization and creation ii) creation of network wrappers and separation 
