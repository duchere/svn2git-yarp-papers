...
delegated to non-trained persons. In research laboratories 
...
a \emph{modular} approach, where software is devided in 
indipendent modules, that can be developed and maintained 
...
as possible to other libraries avoiding to impose contraints 
...
code of our software available so that other 
