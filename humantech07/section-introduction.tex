...
be on the robot, some of which may not be. 
%
We assume diversity:
...
but we don't expect the rest of the world to agree).
%
...
%
We release YARP as Free Software and use it to support our open robot
