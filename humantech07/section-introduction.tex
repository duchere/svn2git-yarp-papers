...
Software development is, in many ways, very like natural 
...
%%
Some niches are very large (for example, commercial PCs), 
some are tiny (a newly developed humanoid).  In this 
paper, we are concerned about the plight of tiny 
niches, and how to prevent ``genetic isolation'' from
setting in, where software development is slow and
