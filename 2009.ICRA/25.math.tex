...
%\noindent where $ERR_{LOO}(y_i)$ is the leave-one-out error for $y_i$, that, the
%error in predicting $y_i$ after having removed it from the training set.
...
Notice that, in the above formula, $\beta$ is the only parameter; hence,
