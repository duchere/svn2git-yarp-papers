{\bf GIORGIO, io scorcerei vigorosamente da qui fino agli asterischi;
...
We then analyzed the error the machine made in predicting the final
...
%% GIORGIO: anche questa parte sarebbe related work...
%%%
