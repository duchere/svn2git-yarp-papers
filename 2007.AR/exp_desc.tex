...
$L^\epsilon$ is a \emph{loss functional}. \textbf{FRANCESCO: breve
spiegazione molto astratta dei due termini}
...
exhibiting poor accuracy on points outside $S$. Smaller values of $C$
give more importance to the regularisation term and vice-versa.
