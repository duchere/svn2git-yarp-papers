...
\begin{figure} \centering
  \begin{tabular}{cc}
    \includegraphics[width=0.23\textwidth]{figs/fig_resCross1_full} &
    \includegraphics[width=0.23\textwidth]{figs/fig_resCross1} \\
    (a) diag: $98.73\% \pm 0.39\%$  & (b) diag: $95.52\% \pm 1.21\%$ \\
        rest: $73.23\% \pm 14.29\%$ & rest: $74.53\% \pm 13.70\%$ \\
    \includegraphics[width=0.23\textwidth]{figs/fig_resCross2_full} &
    \includegraphics[width=0.23\textwidth]{figs/fig_resCross2} \\
