...
% OVERALL NOTES FOR PATRICK:
%
% I am not sure all the very basic explanations about the machine
% learning methods employed would be suitable for PAMI. I guess
% everybody know what we are taking about when we talk about SVMs, there.
%
% may be that PAMI is not the right place to submit, after all... what
% do you think?
%
% reference to your ICRA06 paper is incomplete. I couldn't find the
% vol. and page numbers....
%
% figures are all screwed up - never understood how to fix this.
%
