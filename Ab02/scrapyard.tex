...
Contact with object is sufficient for certain classes of affordances
to come into play (e.g. rolling)

So can use various styles of poking/prodding/tapping/swiping as basic
