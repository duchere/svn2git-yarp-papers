...
objects exist in their own right, or rather they owe their existence
to the interaction with an observer. Being a physical assemblage is
not an intrinsic or primary property, but rather it is something that
derives from the observer. E.g. would a chair, still be a chair if we 
had a completely different embodiment? Further, even if a part of a
physical world could be separated out from the background,
its function still depends on the body and skills of the user -- for 
example, a floppy disk is not of much use to a computer illiterate,
and perhaps can be just regarded as an obstacle depending on the 
circumstances.
...
its existence to you (observer). Yet, the one in the middle for
many of us is still a cross. Clearly, it would still be the case 
...
vs. non-prime'' then a cross can still be identified (assuming 
...
top of the cube? Another possibility is that the cube is extrimely
heavy or even part of the table and thus it is not manipulable or
movable. Does it make sense then to speak about a different object?
We propose that a possible way to find out for sure is to take 
actions and test ourselves. As early as 1734, Berkeley observed that:
%
\begin{quote}
...
\end{quote}
%
Actually, vision is subject to many illusions but these can 
be ususally avoided if we are allowed to take actions.
