...
\section{Developing physical competence}
...
%
The world is complex, but contigent.
...
\subsection{Simplest possible manipulation}

What is the simplest possible manipulative gesture?  Contact with
object is necessary; can't do much without it.  Contact with object is
sufficient for certain classes of affordances to come into play
(e.g. rolling).  So can use various styles of
poking/prodding/tapping/swiping as basic manipulative gestures.  (if
willing to omit the manus from manipulation)
