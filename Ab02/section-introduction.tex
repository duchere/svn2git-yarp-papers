...
\ifrev
Sufficiently sophisticate robots and animals are actors in their environment, not simply passive
\else
...
process that lead to object representation (similar to the 
