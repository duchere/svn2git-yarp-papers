...
\author{
Claudio Castellini\affil{1}{LIRA-Lab, University of Genova, Italy}\affil{4}{German Aerospace Research Center, Oberpfaffenhofen, Germany},
...
\begin{figure*}[t]
  ...
  a single sample of \vlio, \alio, \vttu\ and \attu at time $t_i$ the spectrogram of $19$ 
  $20$-milliseconds long Hamming windows is evaluated. One (central) window is centered at time $t_i$, 9 windows precede it and 9 windows follow it. Each window overlaps by $10$ milliseconds with the preceding window. The spectrogram is computed by using a $20$-filter Mel-scale filterbank.}
  \label{fig:amm}
\end{figure*}
