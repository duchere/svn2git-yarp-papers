...
\begin{abstract}
  ...
  $(b)$ the same features, extracted from AMM-reconstructed MIs, are in general as
    effective as, or slightly better than, the audio features, when testing across
    speakers and coarticulating phonemes; and dramatically better when noise is
