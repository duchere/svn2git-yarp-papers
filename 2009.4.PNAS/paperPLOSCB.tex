...
\end{center}
\caption{{\bf The speech signal and motor trajectories of lips opening
...
\end{center} 
\caption{{\bf Balanced error rate in classification of bilabials and dentals for each
CV schema.}}
...
\end{center} 
\caption{{\bf Balanced error rate in classification of bilabials and dentals for the
