...
\section*{Results}
We first describe the evaluation setting and then show the performance of the AMM and the accuracy of several phone classifiers in three experimental scenarios. The phone classifiers are binary classifiers, the two classes are bilabial (/b/ and /p/) and dental (/d/ and /t/) plosive consonants.
...
\cite{BGV92} (see Materials and Methods). Each classifier uses one of the following feature sets: "Audio", "Real Motor", "Reconstructed Motor" and "Joint" (see Materials and Methods for details).
...
evidence \cite{dausilio} supports even further; our findings seems to support the claim 
