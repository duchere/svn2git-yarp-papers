...
listening to the related piece of speech. According to a widely accepted account on the dorsal-ventral partioning of the brain auditory system \cite{hickok-00,hickok-04} the AMM is located in the dorsal stream, which projects dorso-posteriorly toward the parietal lobe and ultimately to frontal regions (note that the localization of the AMM in the cerebral processing system does not necessarly imply a critical role of the AMM in speech perception \cite{hickok-04,hickok-11})
...
\begin{figure}[ht]
\begin{center}
%\includegraphics[width=4in]{castellini_PLOSCB/samples}
\end{center}
...
\begin{figure}[t]
\begin{center}
%\includegraphics[width=4in]{audio2motor}
\end{center}
...
\begin{figure}[t]
%\centerline{\includegraphics[width=4in]{recMIs}}
...
\begin{figure}[t]
%\centerline{\includegraphics[width=4in]{doubleDiss}}
...
\begin{figure}[ht]
\begin{center}
%\includegraphics[width=4in]{exp2}
\end{center} 
...
\begin{figure}[ht]
\begin{center}
%\includegraphics[width=4in]{exp3}
\end{center} 
