...
\begin{figure}[t]
%\centerline{\includegraphics[width=4in]{figs/recMIs.eps}}
...
\begin{figure}[t]
%\centerline{\includegraphics[width=4in]{figs/doubleDiss.eps}}
...
\begin{figure}[ht]
\begin{center}
%\includegraphics[width=4in]{figs/newaudio2motor.eps}
\end{center} 
