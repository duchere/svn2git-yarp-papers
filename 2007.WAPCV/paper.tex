...
an internal eye or a sort of `zoom lens'. In particular it is
...
Even if supported by numerous findings (a review in \cite{CaveB99}), this view does not
...
The idea of object-based attention is also supported by the discovery in 
...
aim at measuring with ROC-like graphs the distance between the human segmentations
and the artificial ones. We can see the results in Figure
...
In \cite{NataleOBMS05,Orabona07} the visual attention system was also used to
