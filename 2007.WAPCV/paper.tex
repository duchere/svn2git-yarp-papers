...
Figure \ref{fig:out_ex}: in \ref{fig:out_ex} $(d)$ there is a purely bottom-up ($k_{td}=0$,
$k_{bu}=1$ in Equation (7)) map which is the result of the
processing of the scene in \ref{fig:out_ex} $(a)$; in \ref{fig:out_ex} $(e)$ and $(f)$ there are purely
top-down ($k_{td}=1$, $k_{bu}=0$) maps outputs after the
processing of \ref{fig:out_ex} $(b)$ and $(c)$.
