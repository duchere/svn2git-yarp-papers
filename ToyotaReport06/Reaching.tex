...
mse was 5.7 with standard deviation 10.4.
...
} \caption{Learning of the arm forward function.}
...
We report here the result of a learning session. The robot explored 210 different 
...
set was 2, with stadard deviation 7.1. Figure 
...
} \caption{Learning the arm jacobian.} 
\end{figure}
%
