...
effectively reache a straight gaze configuration ($\alpha_v^c 
...
from zero. Finally, the right bottom picture shows the neck movement ($\theta_p$
:solid, $\theta_y$: dashed). The pan and tilt steady state 
