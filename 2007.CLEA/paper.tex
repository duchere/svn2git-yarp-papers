...
signals obtained off more invasive devices than those we use; specific
...
used, with an application to hand prosthestics \cite{yokoi2}.
...
smaller. Interestingly, these good values match those found in
...
associating accuracy and small size.
