...
will see. By the way, notice that, rather counter-intuitively, it has
been shown (see \cite{2008.BioCyb}) that the performance of such
...
threshold $d$ was set a too high a value. In order to test this
