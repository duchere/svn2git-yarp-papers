...
chain events initiated by the robot itself is enough to wipe away much
...
\section{Grounding vision in causal chains}
...
As a point of reference, we now briefly review what is known about
the relationship of object and action representation in the human
brain.
