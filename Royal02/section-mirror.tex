...
axis). Recognition and localization are based on the same \ahhcolor{} 
...
of the fact that the car preferred \ahhbehavior{} is to move along its principal 
...
There are a series of interesting \ahhbehavior{}s that can be realized based
