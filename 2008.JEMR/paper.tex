...
% . 47Hz - I admit that comes from nowhere. I have added a few lines of
%   explanation.
% . Fig. 5 has been improved by neglecting the diagonal (which is useless)
% . typoes fixed
%
% ------------------------------------------------- for reviewer 2:
% . your concerns about fixation vs. raw data are absolutely correct.
%   I have amended and clarified this in Section ``building the data set''.
...
% . more about Tc and C has been put in.
% . typoes corrected.
%
% ------------------------------------------------- for reviewer 3:
% . questions under your point (1) have been, I hope, answered in the
%   section called ``building the data set''.
% . as far as (2) is concerned, you are right
%   about the stimulus picture not being
%   shown. the setup has been dismantled now, so that is it now
%   impossible to take a picture of what was presented to the subjects -
%   I have added a mroe detailed description of it, I hope that fixes
%   your concern.
...
\shorttitle{}
\rightheader{Journal of Eye Movement Research, Volume X, Issue X}
