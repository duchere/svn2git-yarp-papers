...
in a global minimum, $(b)$ their generalisation power is theoretically
...
problem seems to lie in the the sparseness of their solution. That an
...
incremental minimisation algorithm is employed to find the new minimum
